...
public class LatinMorseConverter {
	...
	public final static String ALPHABET_TABLE[] = {
			"a", "._",
			"b", "_...",
			"c", "_._.",
			"d", "_..",
	...
	public LatinMorseConverter(){
		...
		for (int i = 0 ; i < ALPHABET_TABLE.length ;i+=2){
			latinAlphabet.put(ALPHABET_TABLE[i], ALPHABET_TABLE[i+1]);
			morseAlphabet.put(ALPHABET_TABLE[i+1], ALPHABET_TABLE[i]);
		}
	}
